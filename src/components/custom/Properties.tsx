...
export default function Properties() {
  return (
    <div className="w-full px-[15%] max-xl:px-[10%] max-md:px-[8%] max-sm:px-[4%]">
      <div className="rounded-2xl border w-full grid grid-cols-4 max-lg:grid-cols-2 max-sm:grid-cols-1 overflow-hidden">
        {PropertiesData.map((propData: PropertiesType, index: number) => (
          <div
            className="w-full h-full font-geist p-5 flex flex-col justify-center items-center border-l first:border-l-0 max-lg:border-b"
            key={index}
          >
