...
export default function Login() {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <button className="h-full bg-white px-2 py-1 rounded-lg duration-200 ease-out cursor-pointer  hover:inset-shadow-md hover:bg-gray-200 active:scale-[.98] mb-1">
        <span className="text-sm text-black font-geist">Login</span>
      </button>
      <button className=" h-full bg-main-bg-2   border-none outline outline-gray-800 px-2 py-1 rounded-lg duration-200 ease-out cursor-pointer  hover:inset-shadow-md hover:bg-main-bg-1 hover:outline-gray-700 active:scale-[.98]">
