...
export default function HeroSection() {
  return (
    <div className="flex flex-col gap-5 justify-center w-full h-100 mt-17 px-[15%] max-xl:px-[10%] max-md:px-[8%] max-sm:px-[4%]">
      <div className="w-1/3 flex flex-col gap-4">
        <h1 className="font-roboto text-6xl">A link in bio built for you.</h1>
        ...
        <div className="flex gap-5 text-sm text-main-secondary">
        ...
        <button className="w-1/4 h-full bg-white px-3 py-2 rounded-lg duration-200 ease-out cursor-pointer  hover:inset-shadow-md hover:bg-gray-200 active:scale-[.98] ">
          <span className="text-sm text-black font-geist">Try it free</span>
        </button>
      </div>
    </div>
  );
