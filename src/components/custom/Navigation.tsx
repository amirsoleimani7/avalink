...
export default function Navigation() {
  return (
    <div className="fixed w-full backdrop-blur-2xl border-b border-gray-800 text-white flex items py-4  px-[15%] max-xl:px-[10%] max-md:px-[8%] max-sm:px-[4%] justify-between select-none">
